...
| **6. Ambiente de Teste**       | **SO:** Windows 10/11. **Navegador:** Chrome. **Framework:** Cypress 13+. **Servidor:** [https://clinic-mol.quark.tec.br](https://clinic-mol.quark.tec.br) (Servidor fictício). **Banco de Dados:** Simulado via API.                                                                      |
...
| **ID**    | **Cenário de Teste**                            | **Tipo de Teste**          | **Funcionalidade**      | **Cenário BDD (Dado / Quando / Então)**                                                                                                                                                                                                                                                                              | **Resultado Esperado**                                                                                                            |
| --------- | ----------------------------------------------- | -------------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
...
| **CT-03** | Selecionar o primeiro horário disponível do dia | 🟦 Borda (Limite Inferior) | Agendamento de Consulta | **Dado** que o usuário está na tela de “Agendar”<br>**E** existem horários disponíveis para o dia “09/11”<br>**Quando** o usuário seleciona o horário “10:40”<br>**E** confirma o agendamento<br>**Então** o sistema deve exibir a mensagem “Agendamento realizado com sucesso”                                      | O sistema aceita o primeiro horário do dia e registra o agendamento corretamente.                                                 |
